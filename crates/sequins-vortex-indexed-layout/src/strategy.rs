...
// Re-export CompanionIndexBytes so callers can reach it as `indexed_layout::strategy::CompanionIndexBytes`.
pub use sequins_companion_index::CompanionIndexBytes;
