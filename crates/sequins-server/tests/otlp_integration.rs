...
async fn test_trace_ingestion_via_grpc() {
    ...
    assert_eq!(
        received_span.span_kind,
        sequins_core::models::SpanKind::Server
    );
...
async fn test_log_ingestion_via_grpc() {
    ...
    assert_eq!(
        received_log.severity,
        sequins_core::models::LogSeverity::Info
    );
}
...
async fn test_metric_ingestion_via_grpc() {
    ...
    assert_eq!(
        ...
        sequins_core::models::MetricType::Gauge
    );
}
...
async fn test_http_json_span_ingestion() {
    ...
    // Create a test span using Sequins types
    let trace_id = sequins_core::models::TraceId::from_bytes([1; 16]);
    let span_id = sequins_core::models::SpanId::from_bytes([2; 8]);

    let span = SequinsSpan {
        trace_id,
        span_id,
        parent_span_id: None,
        service_name: "test-http-service".to_string(),
        operation_name: "http-operation".to_string(),
        start_time: sequins_core::models::Timestamp::from_secs(1000),
        end_time: sequins_core::models::Timestamp::from_secs(1100),
        duration: sequins_core::models::Duration::from_millis(100),
        attributes: std::collections::HashMap::from([
            (
                "http.method".to_string(),
                sequins_core::models::AttributeValue::String("POST".to_string()),
            ),
            (
                "http.status_code".to_string(),
                sequins_core::models::AttributeValue::Int(201),
            ),
        ]),
        events: vec![],
        status: sequins_core::models::SpanStatus::Ok,
        span_kind: sequins_core::models::SpanKind::Server,
    };
...
async fn test_http_json_log_ingestion() {
    ...
    // Create a test log using Sequins types
    let log = LogEntry {
        id: sequins_core::models::LogId::new(),
        timestamp: sequins_core::models::Timestamp::from_secs(2000),
        observed_timestamp: sequins_core::models::Timestamp::from_secs(2001),
        service_name: "test-http-log-service".to_string(),
        severity: sequins_core::models::LogSeverity::Warn,
        body: "HTTP test log message".to_string(),
        attributes: std::collections::HashMap::from([(
            "component".to_string(),
            sequins_core::models::AttributeValue::String("http-handler".to_string()),
        )]),
        trace_id: None,
        span_id: None,
    ...
    assert_eq!(received_log.severity, sequins_core::models::LogSeverity::Warn);
}
...
async fn test_http_json_metric_ingestion() {
    ...
    // Create a test metric using Sequins types
    let metric = SequinsMetric {
        id: sequins_core::models::MetricId::new(),
        name: "http_requests_total".to_string(),
        description: "Total HTTP requests".to_string(),
        unit: "requests".to_string(),
        metric_type: sequins_core::models::MetricType::Counter,
        service_name: "test-http-metric-service".to_string(),
    };
    ...
    assert_eq!(
        received_metric.metric_type,
        sequins_core::models::MetricType::Counter
    );
}
