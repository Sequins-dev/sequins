...
use sequins_server::ManagementServer;
    ...
    fn new() -> Self {
        Self {
            ...
            policy: Arc::new(Mutex::new(RetentionPolicy {
                spans_retention: sequins_core::models::Duration::from_hours(24),
                logs_retention: sequins_core::models::Duration::from_hours(24),
                metrics_retention: sequins_core::models::Duration::from_hours(24),
                profiles_retention: sequins_core::models::Duration::from_hours(24),
            })),
...
async fn test_get_retention_policy() {
    ...
    let new_policy = RetentionPolicy {
        spans_retention: sequins_core::models::Duration::from_hours(48),
        logs_retention: sequins_core::models::Duration::from_hours(72),
        metrics_retention: sequins_core::models::Duration::from_hours(168),
        profiles_retention: sequins_core::models::Duration::from_hours(24),
    };
...
async fn test_update_retention_policy() {
    ...
    let new_policy = RetentionPolicy {
        spans_retention: sequins_core::models::Duration::from_hours(96),
        logs_retention: sequins_core::models::Duration::from_hours(48),
        metrics_retention: sequins_core::models::Duration::from_hours(336),
        profiles_retention: sequins_core::models::Duration::from_hours(12),
    };
