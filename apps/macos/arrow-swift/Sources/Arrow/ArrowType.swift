...
public class ArrowTypeMap: ArrowType {
    public let keyField: ArrowField
    public let valueField: ArrowField
    public let keysSorted: Bool

    public init(keyField: ArrowField, valueField: ArrowField, keysSorted: Bool = false) {
        self.keyField = keyField
        self.valueField = valueField
        self.keysSorted = keysSorted
        super.init(ArrowType.ArrowMap)
    }
...
public class ArrowType {
    ...
    public static let ArrowStringView = Info.variableInfo(ArrowTypeId.stringView)
    ...
    public static let ArrowMap = Info.complexInfo(ArrowTypeId.map)
    ...
    public func getStride( // swiftlint:disable:this cyclomatic_complexity
        ...
        case .string:
            return MemoryLayout<Int8>.stride
        case .stringView:
            return 16  // each view entry is 16 bytes
        case .strct, .list, .map:
            return 0
        default:
